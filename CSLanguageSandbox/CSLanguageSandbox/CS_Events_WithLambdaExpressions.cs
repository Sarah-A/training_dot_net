...
namespace CS_Events_WithLambdaExpressions
{
    ...
    public class VisibleClock
    {
        ...
        {
            // using a lambda delegate to define and use the delegate 
            theClock.TimeChanged += 
            (sender, e) =>              // This evaluates to a delegate anonymous function
            {
